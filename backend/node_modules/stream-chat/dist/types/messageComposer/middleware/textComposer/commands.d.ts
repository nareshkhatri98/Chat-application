...
export declare class CommandSearchSource extends BaseSearchSource<CommandSuggestion> {
    ...
    protected filterQueryResults(items: CommandSuggestion[]): CommandSuggestion[] | Promise<CommandSuggestion[]>;
}
